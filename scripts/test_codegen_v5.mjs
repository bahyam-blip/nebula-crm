...
section('4. assembleSite');
{
  ...
  ok(html.includes('site-footer') && html.includes(`© ${new Date().getFullYear()} Musafir Coffee`), 'footer chrome present');
  ok(!/crafted by/i.test(html) && !/Nebula agent/i.test(html), 'NO tool credit in the footer (identity law)');
